...
public class main_exe extends Configured implements Tool {
	public int run(String[] args) throws Exception {
	    ...
	    job1.setJarByClass(main_exe.class);
        ...
        job2.setJarByClass(main_exe.class);
        ...
        job3.setJarByClass(main_exe.class);
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new Configuration(), new main_exe(), args));
	}
}
